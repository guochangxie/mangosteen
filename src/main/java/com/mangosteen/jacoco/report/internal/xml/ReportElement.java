...
import com.mangosteen.jacoco.core.analysis.ILine;
import com.mangosteen.jacoco.core.analysis.IMethodCoverage;
...
public class ReportElement extends XMLElement {
	 ...
	 *             in case of problems with the underlying output
	 */
	public void counter(final ICoverageNode.CounterEntity counterEntity,
