...
import com.mangosteen.jacoco.core.analysis.CounterComparator;
...
public abstract class CounterColumn implements IColumnRenderer {
	 ...
	 */
	public static CounterColumn newTotal(final ICoverageNode.CounterEntity entity,
                                         final Locale locale) {
	 ...
	 * @return column instance
	 */
	public static CounterColumn newMissed(final ICoverageNode.CounterEntity entity,
                                          final Locale locale) {
	 ...
	 * @return column instance
	 */
	public static CounterColumn newCovered(final ICoverageNode.CounterEntity entity,
                                           final Locale locale) {
	 ...
	 */
	protected CounterColumn(final ICoverageNode.CounterEntity entity, final Locale locale,
