 ...
 *
 *******************************************************************************/
package com.mangosteen.jacoco.report.internal.html.resources;
...
public class Resources {
	 ...
	 */
	public static String getElementStyle(final ICoverageNode.ElementType type) {
		switch (type) {
		case GROUP:
	...
	private void copyResource(final String name)  {
		//final InputStream in = Resources.class.getResourceAsStream(name);
		ResourceLoader resourceLoader =new DefaultResourceLoader();
		Resource resource = resourceLoader.getResource("classpath:/static/jacoco/" + name);
		InputStream in= null;
		try {
	...
	public static void main(String[] args) {
		...
		//final InputStream in = Resources.class.getResourceAsStream(STYLESHEET);
		ResourceLoader resourceLoader =new DefaultResourceLoader();
		Resource resource = resourceLoader.getResource("classpath:/static/jacoco/" + STYLESHEET);
		try {
